...
<body>
	<form action="boardpost.do">
		제목 : <input type="text" name="subject"> 첨부 : <input
			type="text" name="img"> 첨부 : <input type="text" name="video">
		종류 : <input type="text" name="tb_flag"> 내용 : <input
			type="text" name="msg"> <input type="submit" id="write"
			value="글작성하기">
