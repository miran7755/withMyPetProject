...
public class likeCountController{
	...
	public ModelAndView execute(@ModelAttribute Post post,
								...
								@RequestParam("like_count") int like_count,
								HttpSession session){
		System.out.println("in likeCountController");
		ModelAndView mav = new ModelAndView();
		String url = "/boarddetail.jsp";
				
		post.setPost_no(post_no);
		post.setLike_count(like_count + 1);
				
		try {			
			dao.boardPostLikeCount(post);
